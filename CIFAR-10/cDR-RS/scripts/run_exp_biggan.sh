...
GAN_CKPT_PATH="./CIFAR-10/eval_and_gan_ckpts/BigGAN_39K/G_ema.pth"
...
python main.py \
    ...
    2>&1 | tee output_${GAN_NET}_subsampling_None.txt
...
python main.py \
    ...
    --samp_nfake_per_class $SAMP_NFAKE_PER_CLASS --samp_dump_fake_data \
    --inception_from_scratch --eval --eval_FID_batch_size 200 \
    2>&1 | tee output_${GAN_NET}_subsampling_cDRE_${DRE_DR_LAMBDA}_precnn_${DRE_PRECNN_LAMBDA}.txt