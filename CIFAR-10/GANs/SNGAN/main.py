...
'''                                  Train cGAN                                     '''
#######################################################################################
DiffAugment_info = "None"
if args.gan_DiffAugment:
    DiffAugment_info = args.gan_DiffAugment_policy

filename_gan = os.path.join(save_models_folder, 'ckpt_{}_loss_{}_niters_{}_nDs_{}_DA_{}_seed_{}.pth'.format(args.gan_arch, args.loss_type_gan, args.niters, args.num_D_steps, DiffAugment_info, args.seed))
...
if args.gan_arch=="SNGAN":
    if not os.path.isfile(filename_gan):
        ...
        netG = SNGAN_Generator(dim_z=args.dim_gan, num_classes=args.num_classes)
...
print("\r Time elapses:{}s.".format(timeit.default_timer()-start))
