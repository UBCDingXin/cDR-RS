...
ROOT_PATH="/scratch/dingx92/Subsample_cGANs_via_cDRE/CIFAR-10/GANs/ACGAN"
...
python main.py \
    ...
    --batch_size $BATCHSIZE --lr_g $LR_G --lr_d $LR_D --num_D_steps $nDs --lambda_aux_fake 1.0 \
    --transform \
