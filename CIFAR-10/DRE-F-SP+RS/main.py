        ...
        for nround in range(args.samp_round):
            ...
            if not os.path.isfile(dump_fake_images_filename):
                ...
                for i in range(args.num_classes):
                    ...
                    if args.subsampling:
                        fake_images_i, fake_labels_i = fn_enhancedSampler_given_label(nfake=args.samp_nfake_per_class, given_label=i, batch_size=args.samp_batch_size, verbose=False)
                    else:
