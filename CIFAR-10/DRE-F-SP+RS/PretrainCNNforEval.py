...
trainset = torchvision.datasets.CIFAR10(root=args.data_path+'/data', train=True, download=True, transform=transform_train)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size_train, shuffle=True)

testset = torchvision.datasets.CIFAR10(root=args.data_path+'/data', train=False, download=True, transform=transform_test)
