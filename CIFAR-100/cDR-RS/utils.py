...
################################################################################
# Init. CNNs
def cnn_extract_initialization(cnn_name, num_classes=10):
    if cnn_name == "mobilenet":
        net = mobilenet_v2_extract(extract_features = True, num_classes=num_classes)
    elif cnn_name == "mobilenet_2":
        net = mobilenet_v2_extract_2(num_classes=num_classes)
    elif cnn_name == "ResNet18":
        net = ResNet18_extract(num_classes=num_classes)
