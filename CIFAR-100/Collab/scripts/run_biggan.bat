...
set ROOT_PATH="./CIFAR-100/Collab"
...
set GAN_G_CKPT_PATH="./CIFAR-100/eval_and_gan_ckpts/BigGAN_38K/G_ema.pth"
set GAN_D_CKPT_PATH="./CIFAR-100/eval_and_gan_ckpts/BigGAN_38K/D.pth"
...
python main.py ^
    ...
    --disc_shaping --rollout_rate 0.1 --rollout_steps 30 --batch_size 1000 --lr_d 1e-4 --niter 2500 ^
