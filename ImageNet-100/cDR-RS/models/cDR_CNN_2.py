...
class cDR_CNN_2(nn.Module):
    def __init__(self, img_size=IMG_SIZE, num_classes = 100):
        ...
        self.conv1 = nn.Conv2d(3, 128, kernel_size=4, stride=2, padding=1) # 128x128x3 --> 64x64
        self.norm1 = ConditionalNorm2d(128, num_classes, dim_group=8)

        self.conv2 = nn.Conv2d(128, 256, kernel_size=4, stride=2, padding=1) # 664x64 --> 32x32
        self.norm2 = ConditionalNorm2d(256, num_classes, dim_group=8)

        self.conv3 = nn.Conv2d(256, 512, kernel_size=4, stride=2, padding=1) # 32x32 --> 16x16 
        self.norm3 = ConditionalNorm2d(512, num_classes, dim_group=16)

        self.conv4 = nn.Conv2d(512, 512, kernel_size=4, stride=2, padding=1) # 16x16 --> 8x8
        ...
        self.conv6 = nn.Conv2d(1024, 512, kernel_size=3, stride=1, padding=0) #  4x4 --> 2x2
        self.norm6 = ConditionalNorm2d(512, num_classes, dim_group=16)
...
if __name__ == "__main__":
    num_classes=100
    net = cDR_CNN_2(img_size=128, num_classes=num_classes).cuda()
