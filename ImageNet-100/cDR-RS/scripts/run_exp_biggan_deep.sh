...
python main.py \
    ...
    --dre_precnn_lambda $DRE_PRECNN_LAMBDA \
    ...
    --eval --eval_FID_batch_size 100 \
    --eval_ckpt_path $EVAL_CKPT_PATH --inception_from_scratch \
    2>&1 | tee output_${GAN_NET}_subsampling_cDRE_${DRE_DR}_${DRE_DR_LAMBDA}_precnn_${DRE_PRECNN}_${DRE_PRECNN_LAMBDA}.txt