...
class SAGAN_Generator(nn.Module):
    ...
    def __init__(self, dim_z, num_classes, g_conv_dim=64):
        super(SAGAN_Generator, self).__init__()

        self.dim_z = dim_z
        self.g_conv_dim = g_conv_dim
        self.snlinear0 = snlinear(in_features=dim_z, out_features=g_conv_dim*16*4*4)
...
if __name__ == "__main__":
    ...
    netG = SAGAN_Generator(dim_z=128, num_classes=num_classes, g_conv_dim=64).cuda()
    netD = SAGAN_Discriminator(num_classes=num_classes, d_conv_dim=64).cuda()
