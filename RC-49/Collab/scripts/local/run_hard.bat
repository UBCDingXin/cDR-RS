...
set ROOT_PATH="G:/OneDrive/Working_directory/Subsample_cGANs_via_cDRE/RC-49/RC-49_64x64/Collab"
...
python main.py ^
    ...
    --disc_shaping --rollout_rate 0.5 --rollout_steps 16 --batch_size %TRAIN_BS% --lr_d 1e-4 --niter 20 ^
    --samp_dump_fake_data ^
