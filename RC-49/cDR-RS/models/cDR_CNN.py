...
class cDR_CNN(nn.Module):
    def __init__(self, img_size=IMG_SIZE, dim_cond = 128):
        ...
        self.conv1 = nn.Conv2d(3, 64, kernel_size=4, stride=2, padding=1) # 64x64x3 --> 32x32
        self.norm1 = ConditionalNorm2d(64, dim_cond, dim_group=8)

        self.conv2 = nn.Conv2d(64, 128, kernel_size=4, stride=2, padding=1) # 32x32 --> 16x16
        self.norm2 = ConditionalNorm2d(128, dim_cond, dim_group=8)
        ...
        self.conv5 = nn.Conv2d(512, 512, kernel_size=4, stride=1, padding=0) #  4x4 -->1x1
...
if __name__ == "__main__":
    init_in_dim = 2
    net = cDR_CNN(img_size=64, dim_cond=128).cuda()
