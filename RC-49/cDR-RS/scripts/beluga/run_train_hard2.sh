...
#SBATCH --job-name=RC64_cDREFixH2
...
python main.py \
    ...
    2>&1 | tee output_soft_cDRE-F-cSP+RS_DR_${DRE_DR}_${DRE_DR_LAMBDA}_${DRE_KAPPA}_presae_${DRE_PRESAE_SPARSITY}_${DRE_PRESAE_REGRESSION}.txt
